...
Un respaldo documental grande y citado que **ya alimenta el contenido de la app**: **431 temas** cubiertos dominio por dominio, cada uno con hallazgos, **fuentes enlazadas** (4.126 en total), etiquetas de fiabilidad y una nota **"Para la app"**.
- **226 temas verificados** con verificación adversarial de 3 votos (marcados ✅✅).
- **205 temas en "síntesis desde fuentes canónicas"** (marcados ⚠️) — redactados desde fuentes establecidas cuando el motor de verificación estaba limitado; **pendientes de re-verificar**.
