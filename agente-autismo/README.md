...
**Estado:** app funcional con **buscador sobre 441 temas** (226 verificados) y **4.354 fuentes**, generados desde la biblioteca de investigación ([`research/biblioteca-autismo.md`](research/biblioteca-autismo.md)). Lo hecho y lo pendiente está en **[ESTADO.md](ESTADO.md)**. Proyecto **sin ánimo de lucro** y **gratuito**.
...
1. **📚 Biblioteca buscable (lo principal)** — escribe lo que te preocupa con tus palabras («mi hijo no duerme», «se pega», «en la escuela») y encuentra el tema que responde, con su nivel de evidencia 🟢/🟡/🔴 y sus fuentes. **441 temas** (226 verificados) organizados en 12 categorías. Funciona **sin conexión y sin ningún coste**: no usa IA ni servidores.
...
```
research/
  biblioteca-autismo.md   ← EL CORAZÓN: los 441 temas de la app salen de aquí.
scripts/
